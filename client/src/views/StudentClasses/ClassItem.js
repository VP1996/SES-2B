...
import Modal from '../../components/Interactiveauth/Interactive.js';
				...
				<Card.Body>
					<Card.Text>
						...
						<div className='class-button-group'>
							{!this.props.flags.facial && (
								<img
									src={CameraIcon}
									onClick={() =>
										toast.success(
											'You have successfully passed the facial check.',
										)
									}
								/>
							)}
							...
							{!this.props.flags.captcha && (
								<img src={RoundArrowsIcon} onClick={() => this.showModal()} />
							)}
							{this.props.flags.captcha && <img src={GreenTickIcon} />}
							{!this.props.flags.pin && (
								<img
									src={PinCodeIcon}
									onClick={() => toast.success('Pin check was successful.')}
								/>
							)}
